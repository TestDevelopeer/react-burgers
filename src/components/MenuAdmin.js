        ...
        return (
            <div className={'menu-admin'}>
                ...
                {Object.keys(this.props.burgers).map(key => {
                    return <EditBurgerForm deleteBurger={this.props.deleteBurger} index={key} updateBurger={this.props.updateBurger}
                                           key={`editburger_${key}`} burger={this.props.burgers[key]}/>;
                })}
